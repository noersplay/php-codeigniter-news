<?php if (userdata()) : ?>
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <textarea class="form-control" rows="4" name="comment_body" placeholder="Ketik disini.."></textarea>
...
<?php else : ?>
    <div class="alert alert-info text-center">
        Sign in untuk menuliskan komentar.
...
<div class="card mb-4" id="comment-box">
    <div class="card-body">
        ...
        <?php if (!$comments) : ?>
            <div class="alert alert-warning">Tidak Ada Komentar</div>
        <?php else : ?>
